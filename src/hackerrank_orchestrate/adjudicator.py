...
from hackerrank_orchestrate.evidence_evaluator import EvidenceEvaluation
...
def adjudicate(
    ...
    if "claim_mismatch" in risk_flags and findings.confidence > 0.6:
        justification = (
    ...
    if findings.visible_issue == "none" and findings.confidence > 0.6:
        justification = (
            f"The images do not show any damage on the claimed {findings.object_part}. "
